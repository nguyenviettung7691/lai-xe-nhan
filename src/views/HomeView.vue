...
<template>
  <section class="hero">
    ...
    <div class="hero-art" aria-hidden="true"><div class="road"><span class="dash one" /><span class="dash two" /><span class="dash three" /></div><div class="car"><img src="/favicon.svg" alt="" /></div><span class="spark">✦</span></div>
  </section>
